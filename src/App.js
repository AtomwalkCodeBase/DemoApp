...
const mainRoutes = [
  ...
  { path: "/blog/addBloglifews2026", component: BlogForm, title: "AddBlogForm" },
  { path: "/blog/editlifews2026/:id?", component: BlogForm, title: "EditBlogForm" },
  { path: "/news", component: NewsEventsList, title: "News" },
  { path: "/news/:id", component: NewsEventDetail, title: "AddNewsEvent" },
  { path: "/news/addNewsEventlifews2026", component: NewsEventForm, title: "AddNewsEventForm" },
  { path: "/news/editlifews2026/:id", component: NewsEventForm, title: "AddNewsEventForm" },
  ...
  { path: "/knowledgehub/addknowledgehublifews2026", component: KnowledgeForm, title: "Addknowledgehub" },
  { path: "/knowledgehub/editlifews2026/:id", component: KnowledgeForm, title: "Addknowledgehub" },
