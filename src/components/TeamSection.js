...
import img_4 from "../assets/img/PramilaManohar.jpg";
...
export default function TeamSection() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Dr. Premila Manohar is a research-driven engineering professional with extensive academic and industry experience, specializing in innovation, intellectual property, and technology translation. With a Ph.D. in High Voltage DC (HVDC) Transmission from the Indian Institute of Science, her technical expertise spans Power Systems, Power Electronics, Control Engineering, MEMS, Machine Learning, and Renewable Energy. Her work has resulted in multiple national and international publications. Her strengths lie in technical education, research mentorship,strategic academic leadership, and building strong industry-academia partnerships. Dr. Manohar combines technical insight with a strategic understanding of the IP lifecycle - from ideation to protection - making her well-suited for roles in intellectual property consulting, technology assessment, and innovation management.",
      image: img_4,
    },
    {
