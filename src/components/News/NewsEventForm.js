...
function NewsEventForm() {
        ...
        try {
          ...
          if (metadataDoc.exists() && contentDoc.exists()) {
            ...
            setFormData({
              ...
              coverImagePath: metadata.coverImage?.replace('https://cdn.jsdelivr.net/gh/lifeintelect/storeimage@main/', '') || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const coverImageUrl = `https://cdn.jsdelivr.net/gh/lifeintelect/storeimage@main/${formData.coverImagePath}`;
